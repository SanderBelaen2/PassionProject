<div class="body logincontainer">
<div class="appcontainer appcontainerLoginDesktop">
<section class="login-container">
      ...
      <form class="login-form" method="post" action="index.php?page=login">
        <header>
          ...
          <p class="login__header__goodmorning"><span class="goodmorning">Hi</span>! Login Here!</p>
        </header>
        ...
        <div class="input-container text">
          <label>
            ...
            <input type="password" name="password" placeholder="Password" class="form-input input__password" />
          </label>
        </div>
