...
<head>
  ...
  <body>
    ...
    <?php if($_GET['page'] == 'home' || $_GET['page'] == 'approve' || $_GET['page'] == 'scrape' || $_GET['page'] == 'bugs' || $_GET['page'] == 'verification' || $_GET['page'] == 'ads' || $_GET['page'] == 'autopost'):?>
      ...
      <div class="home__navigation__logo">
        <svg width="27px" height="26px" viewBox="0 0 27 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="logo" fill="#56BFFE">
                    <g id="Group-4" transform="translate(66.500000, 16.000000) rotate(-45.000000) translate(-66.500000, -16.000000) translate(16.000000, -31.000000)">
                        <path d="M2.85,7.5 C2.85,4.935 4.935,2.85 7.5,2.85 L13.5,2.85 L13.5,0 L7.5,0 C3.36,0 1.8189894e-12,3.36 1.8189894e-12,7.5 C1.8189894e-12,11.64 3.36,15 7.5,15 L13.5,15 L13.5,12.15 L7.5,12.15 C4.935,12.15 2.85,10.065 2.85,7.5 L2.85,7.5 Z M9,9 L21,9 L21,6 L9,6 L9,9 L9,9 Z M22.5,0 L16.5,0 L16.5,2.85 L22.5,2.85 C25.065,2.85 27.15,4.935 27.15,7.5 C27.15,10.065 25.065,12.15 22.5,12.15 L16.5,12.15 L16.5,15 L22.5,15 C26.64,15 30,11.64 30,7.5 C30,3.36 26.64,0 22.5,0 L22.5,0 Z" id="Shape"></path>
                    </g>
                </g>
            </g>
        </svg>
          ...
          <ul class="home__navigation">
            <li><a class="home__navigation__item <?php if($_GET['page'] == 'home') echo 'home__navigation__item__active';?>" href="index.php?page=home">
            ...
            <li><a class="home__navigation__item <?php if($_GET['page'] == 'approve') echo 'home__navigation__item__active';?>" href="index.php?page=approve">
            ...
            <li><a class="home__navigation__item <?php if($_GET['page'] == 'scrape') echo 'home__navigation__item__active';?>" href="index.php?page=scrape">
          ...
          <li><a class="home__navigation__item <?php if($_GET['page'] == 'autopost') echo 'home__navigation__item__active';?>" href="index.php?page=autopost">
          ...
          <li><a class="home__navigation__item <?php if($_GET['page'] == 'bugs') echo 'home__navigation__item__active';?>" href="index.php?page=bugs">
