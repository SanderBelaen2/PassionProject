...
<head>
  ...
  <section class="home__header<?php if($_GET['page'] == 'blog' || $_GET['page'] == 'blogpost' || $_GET['page'] == 'about' || $_GET['page'] == 'contact' || $_GET['page'] == 'detail' || $_GET['page'] == 'faq' || $_GET['page'] == 'termsandconditions' || $_GET['page'] == 'privacypolicy') echo '__alt';?>">
